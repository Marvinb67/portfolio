...
$sql = "UPDATE `users` SET (`email`='".$_POST['mail']."',`password`= '".$password_encoder."',`pseudo`='".$_POST['pseudo']."' WHERE id = '".$_SESSION['users']."')" ;
...
<html lang="fr">
  ...
  <body>    
    <form method="POST">
        ...
        <form method ='POST'>
        <div class="form-group">
            <label for="exampleInputPassword1">Modifier mot de passe :</label>
        ...
        <div class="form-group">
            <label for="confirmationmp">Confirmation nouveau mot de passe :</label>
        ...
        <button onclick="return confirm('Are you sure you want to delete your account')" class = "btn btn-danger">Supprimer</button>
